...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="text-akhir">Bahwa yang bersangkutan benar-benar telah Meninggal Dunia pada Hari
                {{ $day_death }}.
                tanggal {{ $date_death }} Tahun {{ $year_death }}. di Kabupaten Bone Bolango karena Sakit dan di
                makamkan di Pekuburan Keluarga
                Desa Uabanga Kecamatan Bonepantai.
