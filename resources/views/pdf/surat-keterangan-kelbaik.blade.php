...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="text-akhir">Bahwa yang bersangkutan benar-benar :</div>

            <ol>
                <li>Berkelakauan baik</li>
                <li>Tidak pernah terlibat pada suatu organisasi terlarang di NKRI seperti G.30/S PKI dan sejenisnya</li>
            </ol>
            <div class="text-akhir">Demikian surat keterangan ini diberikan kepada yang bersangkutan pada keperluan
                pengurusan Rekomendasi SKCK dari Polsek Bonepantai</div>
