    ...
    <div class="pt-4">
        <div class="max-w-7xl px-0 sm:px-6 lg:px-8">
            <div class="mb-3 flex justify-between rounded-lg bg-secondary p-4 text-white shadow-lg">
                ...
                <h2>Edit Data Sarana Perikanan</h2>
            ...
            <div class="rounded-lg bg-white p-4 text-white shadow-lg">
                ...
                <form class="mx-auto max-w-full"
                    action="{{ route('admin.sarana_perikanan.update', ['sarana_perikanan' => $sarana_perikanans->id]) }}"
                    method="POST">
                    @method('PUT')
                    @csrf
                            ...
                            <select
                                ...
                                @foreach ($villages as $village)
                                    <option value="{{ $village->id }}"
                                        {{ old('village_id', $sarana_perikanans->village_id) == $village->id ? 'selected' : '' }}>
                    ...
                    <div class="grid w-full grid-cols-3 gap-4">
                        <div class="grid w-full grid-cols-2 gap-2">
                            <div>
                                ...
                                <input
                                    class="block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="tambatan" name="tambatan" type="number"
                                    value="{{ old('tambatan', $sarana_perikanans->tambatan) }}" placeholder="0"
                                    required />
                                @error('tambatan')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    id="pasar_ikan" name="pasar_ikan" type="number"
                                    value="{{ old('pasar_ikan', $sarana_perikanans->pasar_ikan) }}" placeholder="0"
                                    required />
                                @error('pasar_ikan')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="grid w-full grid-cols-2 gap-2">
                            <div>
                                ...
                                <input
                                    class="block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="pajeko" name="pajeko" type="number"
                                    value="{{ old('pajeko', $sarana_perikanans->pajeko) }}" placeholder="0"
                                    required />
                                @error('pajeko')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('kapal_ikan', $sarana_perikanans->kapal_ikan) }}" placeholder="0"
                                    required />
                                @error('kapal_ikan')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="grid w-full grid-cols-3 gap-2">
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('perahu_bodi', $sarana_perikanans->perahu_bodi) }}" placeholder="0"
                                    required />
                                @error('perahu_bodi')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value="{{ old('mesin_tempel', $sarana_perikanans->mesin_tempel) }}"
                            ...
                            <div>
                                ...
                                <input
                                    class="col-span-2 block w-full rounded-lg border border-secondary bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-secondary dark:border-secondary dark:bg-gray-700 dark:text-white"
                                    id="katintin" name="katintin" type="number"
                                    value="{{ old('katintin', $sarana_perikanans->katintin) }}" placeholder="0"
                                    required />
                                @error('katintin')
                                    <span class="text-sm text-red-500">{{ $message }}</span>
                                @enderror
