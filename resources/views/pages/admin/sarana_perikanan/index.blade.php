    ...
    <div class="pt-4">
        <div class="max-w-full px-3 sm:px-6 lg:px-8">
            <div class="mb-3 flex justify-between rounded-lg bg-secondary p-4 text-white shadow-lg">
                ...
                <h2>Data Sarana / Prasarana Perikanan</h2>
            ...
            <div class="rounded-lg bg-white p-4 text-white shadow-lg">
                ...
                <div class="mb-2 flex flex-col items-center sm:flex-row">
                    <form class="mb-2 w-full sm:mb-0 sm:me-2" action="{{ route('admin.sarana_perikanan.index') }}"
                        method="GET">
                    ...
                    <a class="mb-2 w-full rounded-lg bg-green-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 sm:mb-0 sm:me-2 sm:w-auto"
                        href="{{ route('admin.sarana_perikanan.create') }}">
                ...
                <div class="relative overflow-x-auto">
                    <table
                        ...
                        <thead class="bg-gray-50 text-xs uppercase text-gray-700 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th class="border border-gray-300 px-6 py-3 text-center" colspan="7">Sarana Dan
                                    Prasarana Perikanan</th>
                                <th class="border border-gray-300 px-6 py-3" scope="row" rowspan="2">Aksi</th>
                            </tr>
                            <tr>
                                <th class="border border-gray-300 px-6 py-3">Tambatan</th>
                                <th class="border border-gray-300 px-6 py-3">Pasar Ikan</th>
                                <th class="border border-gray-300 px-6 py-3">Pajeko</th>
                                <th class="border border-gray-300 px-6 py-3">Kapal Ikan</th>
                                <th class="border border-gray-300 px-6 py-3">Perahu Bodi</th>
                                <th class="border border-gray-300 px-6 py-3">Mesin Tempel</th>
                                <th class="border border-gray-300 px-6 py-3">Katintin</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($sarana_perikanans as $sarana_perikanan)
                                <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                                    <th class="whitespace-nowrap border border-gray-300 px-6 py-4 font-medium text-gray-900 dark:text-white"
                                        scope="row">
                                        {{ ($sarana_perikanans->currentPage() - 1) * $sarana_perikanans->perPage() + $loop->iteration }}
                                    </th>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $sarana_perikanan->village_name }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $sarana_perikanan->tambatan }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $sarana_perikanan->pasar_ikan }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $sarana_perikanan->pajeko }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $sarana_perikanan->kapal_ikan }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $sarana_perikanan->perahu_bodi }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $sarana_perikanan->mesin_tempel }}
                                    </td>
                                    <td class="border border-gray-300 px-6 py-4">
                                        {{ $sarana_perikanan->katintin }}
                                    </td>

                                    <td class="border border-gray-300 px-6 py-4">
                                        <div class="flex items-center">
                                            <a
                                                href="{{ route('admin.sarana_perikanan.edit', ['sarana_perikanan' => $sarana_perikanan->id]) }}">
                                            ...
                                            <a href="javascript:void(0);"
                                                onclick="confirmDelete('{{ $sarana_perikanan->id }}', '{{ addslashes($sarana_perikanan->village_name) }}')">
                                            ...
                                            <form id="delete-form-{{ $sarana_perikanan->id }}" style="display: none;"
                                                action="{{ route('admin.sarana_perikanan.destroy', ['sarana_perikanan' => $sarana_perikanan->id]) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                    ...
                    {{ $sarana_perikanans->links('vendor.pagination.tailwind') }}
                </div>
            </div>
        </div>
