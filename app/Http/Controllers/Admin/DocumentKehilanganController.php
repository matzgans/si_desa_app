...
class DocumentKehilanganController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view("pages.admin.document_kehilangan.index", compact('documents'));
    }
    ...
    public function edit($id)
    {
        ...
        return view("pages.admin.document_kehilangan.edit", compact("data", "id", "no_surat"));
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect()
                ->route("admin.document.kehilangan.index")
