...
class VillageController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($search) {
            # code...
            $villages = Village::where('village_name', 'like', '%' . $search . '%')->orderBy('village_name', 'DESC')->paginate(4)->appends(['search' => $search]);
        } else {

            $villages = Village::orderBy('village_name', 'DESC')->paginate(4); // Ganti 10 dengan jumlah item per halaman yang diinginkan
        }
